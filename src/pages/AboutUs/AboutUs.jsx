        ...
        <div className="container">
          <div className="story-grid">
            <div className="story-content">
              <h2>Наша история</h2>
              <p>
                Всё началось с маленькой лавки в Западном районе Ростова-на-Дону, на проспекте Стачки, где создавались букеты для друзей. Где страсть и внимание владелицы к деталям быстро завоевали сердца.
              </p>
              <p>
                Сегодня «Бутон» — это команда профессионалов, которая сохраняет тёплую атмосферу и индивидуальный подход, даже став узнаваемым брендом.
              </p>
